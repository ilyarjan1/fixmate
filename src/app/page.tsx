        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl text-foreground leading-tight">
              Fast, reliable appliance repair—<span className="text-primary">done right.</span>
            </h1>
      ...
      <section className="py-20 section-alt">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight mb-3">Why Choose FixMate?</h2>
            <p className="text-muted-foreground/70 text-lg">Professional service you can trust</p>
          </div>
